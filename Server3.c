...
void * serverStart3(void *vargs);
void * listenMessageServer3(void *vargs);
...
int main(){
  ...
  pthread_t thread;
  pthread_create(&thread, NULL, serverStart3, NULL);
...
void* serverStart3(void *vargs){
    ...
    serverAddr.sin_port = htons(8183);
    ...
    pthread_create(&t2,NULL,listenMessageServer3,NULL);
