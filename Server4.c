...
void * serverStart4(void *vargs);
void * listenMessageServer4(void *vargs);
...
int main(){
  ...
  pthread_t thread;
  pthread_create(&thread, NULL, serverStart4, NULL);
...
void* serverStart4(void *vargs){
    ...
    serverAddr.sin_port = htons(8184);
    ...
    pthread_create(&t2,NULL,listenMessageServer4,NULL);
